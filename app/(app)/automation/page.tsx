...
export default function AutomationPage() {
  ...
  return (
    <div className="max-w-[880px] mx-auto px-5 sm:px-7 py-8 animate-pageIn">
      {/* header */}
      <div className="flex items-start gap-4">
        <div className="flex-1 min-w-0">
          <h1 className="text-[25px] font-semibold tracking-[-0.024em]">Automation</h1>
          <p className="text-[13.5px] text-muted mt-1.5">Email sequences that run themselves.</p>
        </div>
      </div>
