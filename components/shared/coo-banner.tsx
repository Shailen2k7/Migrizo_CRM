    ...
    <div className="max-w-[1480px] mx-auto px-4 sm:px-6 lg:px-8 pt-4">
      <div className="coo-banner relative overflow-hidden rounded-2xl px-4 sm:px-5 py-3.5 flex items-center gap-3.5">
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          {/* AI COO lives here now rather than in the sidebar — it belongs
              with the briefing it answers questions about. */}
          <Link href="/ai"
            className="flex items-center gap-1.5 text-[12px] sm:text-[12.5px] font-bold px-3 py-2 rounded-lg text-white transition-colors whitespace-nowrap"
            style={{ background: 'rgba(255,255,255,0.18)', border: '1px solid rgba(255,255,255,0.28)' }}>
            <Sparkles className="w-3.5 h-3.5" />
            <span className="hidden sm:inline">Ask AI COO</span>
