...
const PUBLIC_PATHS = ['/login', '/auth/callback', '/api/ingest', '/api/push/dispatch', '/api/campaigns/drain', '/api/sequences/tick', '/api/unsubscribe', '/book', '/api/booking', '/api/scheduler/remind', '/api/email/inbound', '/api/email/bounce', '/api/whatsapp/webhook'];
