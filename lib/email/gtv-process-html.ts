// =============================================================================
// GTV "HOW IT WORKS" EMAIL — the approved premium process email.
// Sent from the lead drawer's "How it works" button.
//
//  - Hero served from crm.migrizo.com/gtv-hero.jpg (Gmail strips base64 URIs).
//  - Icon cards are icon-LEFT / content-RIGHT and stay TWO per row on mobile;
//    the icon tile and type shrink via media query so nothing looks lost.
//  - "Jump to a section" uses true in-page anchors (#id) with <a name> targets.
//    Apple Mail / most desktop clients jump; Gmail's app ignores anchors (a
//    platform limitation). A "View in browser" link opens gtv-info.html, an
//    identical hosted copy where the anchors always work.
//  - Email-safe: inline CSS, table layout, no JavaScript. ~76KB (<102KB clip).
// =============================================================================
...
<head>
  ...
  <style type="text/css">
    ...
    /* Mobile responsive.
       Only cards that truly need full width carry .stack. Icon cards stay 2-up
       (and LOR chips 3-up) on mobile; we shrink the icon tile and type instead,
       so the phone screen stays dense and legible. */
    @media only screen and (max-width:600px) {
      ...
      .ic-cell     { padding:4px !important; }
      .ic-iconcell { width:46px !important; padding:11px 0 11px 9px !important; }
      .ic-icon     { width:34px !important; height:34px !important; line-height:34px !important; font-size:17px !important; border-radius:9px !important; }
      .ic-textcell { padding:11px 9px 11px 8px !important; }
      .ic-title    { font-size:11.5px !important; line-height:1.3 !important; }
      .ic-desc     { font-size:10px !important; line-height:1.45 !important; }
      .lor-chip    { font-size:9.5px !important; padding:8px 3px !important; }
      .lor-cell    { padding:3px !important; }
      .chk         { font-size:11.5px !important; padding:10px 11px !important; }
      .chk-cell    { padding:3px !important; }
      .toc-chip    { font-size:10.5px !important; padding:6px 9px !important; }
    }
  </style>
  <![endif]-->
  <style type="text/css">
    ...
    <tr>
      <td align="center" class="outer-pad" style="padding:24px 12px;">
        ...
        <table role="presentation" class="container" width="640" cellpadding="0" cellspacing="0" style="width:640px; max-width:640px; background-color:#FFFFFF; border-radius:18px; overflow:hidden; box-shadow:0 8px 30px rgba(22,41,78,0.10);">
          ...
          <!-- ===================== 1. HERO ===================== -->
          <tr>
            <td style="background-color:#FFFFFF; padding:12px 32px 0 32px;" align="right">
              <a href="https://crm.migrizo.com/gtv-info.html" target="_blank" style="font-size:10.5px; color:#9AA0AC; font-family:Arial,Helvetica,sans-serif;">View in browser →</a>
            </td>
          </tr>
          <tr>
          ...
          <!-- ===== TABLE OF CONTENTS — true in-page anchors (#id). Jumps inside the
               email; never navigates away, never 404s. ===== -->
          <tr>
          ...
          <tr>
            <td class="stack-pad" style="padding:34px 32px 8px 32px;" align="left">
              ...
              <a name="about" id="about"></a><h2 class="h2" id="about" style="margin:0 0 12px 0; font-size:22px; color:#16294E; font-family:Arial,Helvetica,sans-serif; font-weight:800;">What is the UK Global Talent Visa?</h2>
          ...
          <tr>
            <td class="stack-pad" style="padding:30px 32px 6px 32px;" align="left">
              <div style="width:34px; height:3px; background-color:#3E56D4; border-radius:2px; margin-bottom:14px;"></div>
              <a name="benefits" id="benefits"></a><h2 class="h2" id="benefits" style="margin:0 0 4px 0; font-size:22px; color:#16294E; font-family:Arial,Helvetica,sans-serif; font-weight:800;">Why choose this visa?</h2>
          ...
          <tr>
            <td class="stack-pad" style="padding:0 26px 14px 26px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F5F7FC; border:1px solid #E7EAF1; border-radius:12px;">
                      <tr>
                        <td class="ic-iconcell" width="62" valign="middle" style="padding:14px 0 14px 14px;">
                          <div class="ic-icon" style="width:46px; height:46px; border-radius:12px; background:#FFFFFF; border:1px solid #E7EAF1; text-align:center; line-height:46px; font-size:24px;">🚫</div>
                        </td>
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">No Job Offer Required</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F5F7FC; border:1px solid #E7EAF1; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">No Sponsorship Required</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F5F7FC; border:1px solid #E7EAF1; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Freedom to Work</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F5F7FC; border:1px solid #E7EAF1; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Freedom to Freelance</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F5F7FC; border:1px solid #E7EAF1; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Start Your Own Business</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F5F7FC; border:1px solid #E7EAF1; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Bring Your Family</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F5F7FC; border:1px solid #E7EAF1; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Spouse Can Work</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F5F7FC; border:1px solid #E7EAF1; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">ILR Pathway</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F5F7FC; border:1px solid #E7EAF1; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">British Citizenship Opportunity</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%"></td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <tr>
            <td style="background-color:#F5F7FC; padding:30px 32px 8px 32px;" class="stack-pad" align="left">
              <div style="width:34px; height:3px; background-color:#3E56D4; border-radius:2px; margin-bottom:14px;"></div>
              <a name="who" id="who"></a><h2 class="h2" id="who" style="margin:0 0 4px 0; font-size:22px; color:#16294E; font-family:Arial,Helvetica,sans-serif; font-weight:800;">Who can apply?</h2>
          ...
          <tr>
            <td style="background-color:#F5F7FC; padding:6px 26px 22px 26px;" class="stack-pad">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        <td class="ic-iconcell" width="62" valign="middle" style="padding:14px 0 14px 14px;">
                          <div class="ic-icon" style="width:46px; height:46px; border-radius:12px; background:#F5F7FC; border:1px solid #E1E6F2; text-align:center; line-height:46px; font-size:24px;">💻</div>
                        </td>
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Software Engineers</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">AI & ML Professionals</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Data Scientists</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        <td class="ic-iconcell" width="62" valign="middle" style="padding:14px 0 14px 14px;">
                          <div class="ic-icon" style="width:46px; height:46px; border-radius:12px; background:#F5F7FC; border:1px solid #E1E6F2; text-align:center; line-height:46px; font-size:24px;">🛡️</div>
                        </td>
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Cyber Security Experts</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Tech Founders</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Product Managers</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Researchers</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Academics</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Architects</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Designers</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Engineers</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Creative Professionals</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
          ...
          <tr>
            <td class="stack-pad" style="padding:0 26px 18px 26px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#EEF2FF; border:1px solid #D9DFF0; border-radius:12px;">
                      <tr>
                        <td class="ic-iconcell" width="62" valign="middle" style="padding:14px 0 14px 14px;">
                          <div class="ic-icon" style="width:46px; height:46px; border-radius:12px; background:#FFFFFF; border:1px solid #D9DFF0; text-align:center; line-height:46px; font-size:24px;">💷</div>
                        </td>
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">High Salaries</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#EEF2FF; border:1px solid #D9DFF0; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Global Companies</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#EEF2FF; border:1px solid #D9DFF0; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">NHS Healthcare</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#EEF2FF; border:1px solid #D9DFF0; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Excellent Education</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#EEF2FF; border:1px solid #D9DFF0; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Startup Ecosystem</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#EEF2FF; border:1px solid #D9DFF0; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Innovation Hub</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#EEF2FF; border:1px solid #D9DFF0; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Multicultural Society</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#EEF2FF; border:1px solid #D9DFF0; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Strong Economy</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td class="ic-cell" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#EEF2FF; border:1px solid #D9DFF0; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Permanent Residency Pathway</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="ic-cell" width="50%"></td>
          ...
          <tr>
            <td style="background-color:#16294E; padding:32px 32px 8px 32px;" class="stack-pad" align="left">
              ...
              <a name="need" id="need"></a><h2 class="h2" id="need" style="margin:0 0 4px 0; font-size:22px; color:#FFFFFF; font-family:Arial,Helvetica,sans-serif; font-weight:800;">What we need from you</h2>
          ...
          <tr>
            <td style="background-color:#16294E; padding:6px 26px 8px 26px;" class="stack-pad">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-family:Arial,Helvetica,sans-serif;">
                <tr>
                  <td class="chk-cell" width="50%" valign="top" style="padding:5px;"><div class="chk" style="background:#1E3358; border:1px solid #2C446E; border-radius:10px; padding:11px 14px; font-size:12.5px; color:#E7ECF7;">✅&nbsp; Updated CV</div></td>
                  <td class="chk-cell" width="50%" valign="top" style="padding:5px;"><div class="chk" style="background:#1E3358; border:1px solid #2C446E; border-radius:10px; padding:11px 14px; font-size:12.5px; color:#E7ECF7;">✅&nbsp; LinkedIn Profile</div></td>
                </tr>
                <tr>
                  <td class="chk-cell" width="50%" valign="top" style="padding:5px;"><div class="chk" style="background:#1E3358; border:1px solid #2C446E; border-radius:10px; padding:11px 14px; font-size:12.5px; color:#E7ECF7;">✅&nbsp; Passport</div></td>
                  <td class="chk-cell" width="50%" valign="top" style="padding:5px;"><div class="chk" style="background:#1E3358; border:1px solid #2C446E; border-radius:10px; padding:11px 14px; font-size:12.5px; color:#E7ECF7;">✅&nbsp; Educational Documents</div></td>
                </tr>
                <tr>
                  <td class="chk-cell" width="50%" valign="top" style="padding:5px;"><div class="chk" style="background:#1E3358; border:1px solid #2C446E; border-radius:10px; padding:11px 14px; font-size:12.5px; color:#E7ECF7;">✅&nbsp; Employment Letters</div></td>
                  <td class="chk-cell" width="50%" valign="top" style="padding:5px;"><div class="chk" style="background:#1E3358; border:1px solid #2C446E; border-radius:10px; padding:11px 14px; font-size:12.5px; color:#E7ECF7;">✅&nbsp; Salary Slips <span style="color:#8FA6E8;">(if available)</span></div></td>
                </tr>
                <tr>
                  <td class="chk-cell" width="50%" valign="top" style="padding:5px;"><div class="chk" style="background:#1E3358; border:1px solid #2C446E; border-radius:10px; padding:11px 14px; font-size:12.5px; color:#E7ECF7;">✅&nbsp; Awards &amp; Achievements <span style="color:#8FA6E8;">(if any)</span></div></td>
                  <td class="chk-cell" width="50%" valign="top" style="padding:5px;"><div class="chk" style="background:#1E3358; border:1px solid #2C446E; border-radius:10px; padding:11px 14px; font-size:12.5px; color:#E7ECF7;">✅&nbsp; Publications <span style="color:#8FA6E8;">(if any)</span></div></td>
                </tr>
                <tr>
                  <td class="chk-cell" width="50%" valign="top" style="padding:5px;"><div class="chk" style="background:#1E3358; border:1px solid #2C446E; border-radius:10px; padding:11px 14px; font-size:12.5px; color:#E7ECF7;">✅&nbsp; Speaking Engagements <span style="color:#8FA6E8;">(if any)</span></div></td>
                  <td class="chk-cell" width="50%" valign="top" style="padding:5px;"><div class="chk" style="background:#1E3358; border:1px solid #2C446E; border-radius:10px; padding:11px 14px; font-size:12.5px; color:#E7ECF7;">✅&nbsp; Media Features</div></td>
                </tr>
                <tr>
                  <td class="chk-cell" width="50%" valign="top" style="padding:5px;"><div class="chk" style="background:#1E3358; border:1px solid #2C446E; border-radius:10px; padding:11px 14px; font-size:12.5px; color:#E7ECF7;">✅&nbsp; Portfolio / GitHub / Projects <span style="color:#8FA6E8;">(if any)</span></div></td>
                  <td class="chk-cell" width="50%" valign="top" style="padding:5px;"><div class="chk" style="background:#1E3358; border:1px solid #2C446E; border-radius:10px; padding:11px 14px; font-size:12.5px; color:#E7ECF7;">✅&nbsp; Business Docs <span style="color:#8FA6E8;">(if founder)</span></div></td>
                </tr>
              </table>
            </td>
          </tr>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFBEB; border-radius:14px;">
                <tr>
                  <td style="padding:18px 20px;" align="left">
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-family:Arial,Helvetica,sans-serif;">
                      <tr>
                        <td class="lor-cell" width="33.33%" style="padding:4px;"><div class="lor-chip" style="background:#FFFFFF; border:1px solid #F0E4BE; border-radius:8px; padding:9px 6px; text-align:center; font-size:11.5px; font-weight:600; color:#7A5B00;">👔 CEO / Founder</div></td>
                        <td class="lor-cell" width="33.33%" style="padding:4px;"><div class="lor-chip" style="background:#FFFFFF; border:1px solid #F0E4BE; border-radius:8px; padding:9px 6px; text-align:center; font-size:11.5px; font-weight:600; color:#7A5B00;">🎖️ Director / VP</div></td>
                        <td class="lor-cell" width="33.33%" style="padding:4px;"><div class="lor-chip" style="background:#FFFFFF; border:1px solid #F0E4BE; border-radius:8px; padding:9px 6px; text-align:center; font-size:11.5px; font-weight:600; color:#7A5B00;">🎓 Professor</div></td>
                      </tr>
                      <tr>
                        <td class="lor-cell" width="33.33%" style="padding:4px;"><div class="lor-chip" style="background:#FFFFFF; border:1px solid #F0E4BE; border-radius:8px; padding:9px 6px; text-align:center; font-size:11.5px; font-weight:600; color:#7A5B00;">🧑‍💼 Senior Manager</div></td>
                        <td class="lor-cell" width="33.33%" style="padding:4px;"><div class="lor-chip" style="background:#FFFFFF; border:1px solid #F0E4BE; border-radius:8px; padding:9px 6px; text-align:center; font-size:11.5px; font-weight:600; color:#7A5B00;">🛠️ CTO / Tech Lead</div></td>
                        <td class="lor-cell" width="33.33%" style="padding:4px;"><div class="lor-chip" style="background:#FFFFFF; border:1px solid #F0E4BE; border-radius:8px; padding:9px 6px; text-align:center; font-size:11.5px; font-weight:600; color:#7A5B00;">🌟 Industry Leader</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
          ...
          <tr>
            <td class="stack-pad" style="padding:34px 32px 10px 32px;" align="left">
              <div style="width:34px; height:3px; background-color:#3E56D4; border-radius:2px; margin-bottom:14px;"></div>
              <a name="process" id="process"></a><h2 class="h2" id="process" style="margin:0 0 4px 0; font-size:22px; color:#16294E; font-family:Arial,Helvetica,sans-serif; font-weight:800;">Our complete 7-step process</h2>
          ...
          <tr>
            <td class="stack-pad" style="padding:22px 32px 6px 32px;" align="left">
              <div style="width:34px; height:3px; background-color:#3E56D4; border-radius:2px; margin-bottom:14px;"></div>
              <a name="pricing" id="pricing"></a><h2 class="h2" id="pricing" style="margin:0 0 16px 0; font-size:22px; color:#16294E; font-family:Arial,Helvetica,sans-serif; font-weight:800;">Total estimated cost</h2>
            </td>
          </tr>
          <tr>
                  ...
                  <td class="stack" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">End-to-End Support</div><div class="ic-desc" style="margin-top:4px; font-size:12.5px; color:#6B7280; line-height:1.55; font-family:Arial,Helvetica,sans-serif;">From first assessment to landing — one team, every stage.</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="stack" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Expert Guidance</div><div class="ic-desc" style="margin-top:4px; font-size:12.5px; color:#6B7280; line-height:1.55; font-family:Arial,Helvetica,sans-serif;">Real endorsement-criteria expertise, not generic advice.</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td class="stack" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Transparent Pricing</div><div class="ic-desc" style="margin-top:4px; font-size:12.5px; color:#6B7280; line-height:1.55; font-family:Arial,Helvetica,sans-serif;">A fixed £3,000 fee, clear milestones, no hidden charges.</div></td>
                      </tr>
                    </table>
                  </td>
                  <td class="stack" width="50%" valign="top" style="padding:6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #E1E6F2; border-radius:12px;">
                      <tr>
                        ...
                        <td class="ic-textcell" valign="middle" style="padding:14px 14px 14px 12px;"><div class="ic-title" style="font-size:14.5px; font-weight:700; color:#16294E; font-family:Arial,Helvetica,sans-serif; line-height:1.35;">Dedicated Case Manager</div><div class="ic-desc" style="margin-top:4px; font-size:12.5px; color:#6B7280; line-height:1.55; font-family:Arial,Helvetica,sans-serif;">A single point of contact throughout your journey.</div></td>
                      </tr>
                    </table>
                  </td>
                </tr>
